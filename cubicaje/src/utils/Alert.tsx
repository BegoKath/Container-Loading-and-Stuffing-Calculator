...
export class Alert{
  ...
  static showError = async (message: string, opts?: { title?: string, timer?: number }) => {
  ...
  static showWarning = async (message: string, opts?: { title?: string, timer?: number }) => {
    await this.mySwal.fire({
      icon: 'warning',
      title: opts?.title ?? '',
      text: message,
  ...
  static showSuccess = async (params: { message: string, title?: string, timer?: number, showConfirmButton?: boolean }) => {
